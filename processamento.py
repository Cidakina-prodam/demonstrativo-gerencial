                    ...
                    if ativs:
                        ...
                        for atv in ativs:
                            ...
                            if not lancs and gdp:
                                ...
                                if gdp == "173276":
                                    import sys
                                    print(f"DEBUG GDP 173276: atv={atv} lancs_lanc={bool(mapa_lanc.get(atv,[]))} lancs_gdp_fb={len(lancs_gdp_fb)} todos_ids={todos_ids_csv} lancs_final={len(lancs)}", file=sys.stderr)
